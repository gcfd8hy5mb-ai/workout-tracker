...
document:{getElementById:id=>id==='prismProFeedbackStatus'?status:null}
};
...
assert.match(context.prismProFeaturePreview('plateau_detection'),/COMING LATER/);
...
console.log('Pro examples, labeled samples, separate feedback, and preserved user data: OK');
